// <copyright file="PreOrderTreeTest.cs" company="GeneGenie.com">
//
...
namespace GeneGenie.Gedcom.Tests
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreOrderTreeTest"/> class.
        /// </summary>
        public PreOrderTreeTest()
            : base(TraversalType.Pre)
        {
